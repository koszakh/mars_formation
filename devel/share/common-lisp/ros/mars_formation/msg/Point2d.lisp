...
(cl:defmethod cl:initialize-instance :after ((m <Point2d>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point2d)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mars_formation-msg:<Point2d> is deprecated: use mars_formation-msg:Point2d instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Point2d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mars_formation-msg:x-val is deprecated.  Use mars_formation-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Point2d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mars_formation-msg:y-val is deprecated.  Use mars_formation-msg:y instead.")
  (y m))
